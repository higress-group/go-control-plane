...
var _HealthCheck_HttpHealthCheck_Host_Pattern = regexp.MustCompile(`^[^\x00-\x08\x0a-\x1f\x7f]*$`)

var _HealthCheck_HttpHealthCheck_Path_Pattern = regexp.MustCompile(`^[^\x00-\x08\x0a-\x1f\x7f]*$`)
