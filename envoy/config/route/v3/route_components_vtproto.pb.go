...
func (m *VirtualHost) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.AllowServerNames) > 0 {
		for iNdEx := len(m.AllowServerNames) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AllowServerNames[iNdEx])
			copy(dAtA[i:], m.AllowServerNames[iNdEx])
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.AllowServerNames[iNdEx])))
			i--
			dAtA[i] = 0x6
			i--
			dAtA[i] = 0xaa
...
func (m *WeightedCluster) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.ClusterSpecifierPlugin) > 0 {
...
func (m *RouteAction) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.InternalActiveRedirectPolicy != nil {
		size, err := m.InternalActiveRedirectPolicy.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *InternalActiveRedirectPolicy_RedirectPolicy) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *InternalActiveRedirectPolicy_RedirectPolicy) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *InternalActiveRedirectPolicy_RedirectPolicy) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if msg, ok := m.RedirectUrlRewriteSpecifier.(*InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrlRewriteRegex); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.RedirectUrlRewriteSpecifier.(*InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrl); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrl) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrl) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.RedirectUrl)
...
func (m *InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrlRewriteRegex) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrlRewriteRegex) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.RedirectUrlRewriteRegex != nil {
		if vtmsg, ok := interface{}(m.RedirectUrlRewriteRegex).(interface {
			MarshalToSizedBufferVTStrict([]byte) (int, error)
		}); ok {
			size, err := vtmsg.MarshalToSizedBufferVTStrict(dAtA[:i])
			if err != nil {
			...
			encoded, err := proto.Marshal(m.RedirectUrlRewriteRegex)
			if err != nil {
				return 0, err
			}
			i -= len(encoded)
...
func (m *InternalActiveRedirectPolicy) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *InternalActiveRedirectPolicy) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *InternalActiveRedirectPolicy) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if msg, ok := m.RedirectUrlRewriteSpecifier.(*InternalActiveRedirectPolicy_RedirectUrlRewriteRegex); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.RedirectUrlRewriteSpecifier.(*InternalActiveRedirectPolicy_RedirectUrl); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *InternalActiveRedirectPolicy_RedirectUrl) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *InternalActiveRedirectPolicy_RedirectUrl) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.RedirectUrl)
	copy(dAtA[i:], m.RedirectUrl)
	i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.RedirectUrl)))
...
func (m *InternalActiveRedirectPolicy_RedirectUrlRewriteRegex) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *InternalActiveRedirectPolicy_RedirectUrlRewriteRegex) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.RedirectUrlRewriteRegex != nil {
		if vtmsg, ok := interface{}(m.RedirectUrlRewriteRegex).(interface {
			MarshalToSizedBufferVTStrict([]byte) (int, error)
...
func (m *VirtualHost) SizeVT() (n int) {
	...
	if len(m.AllowServerNames) > 0 {
		for _, s := range m.AllowServerNames {
			l = len(s)
			n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
		}
	}
...
func (m *RouteAction) SizeVT() (n int) {
	...
	if m.InternalActiveRedirectPolicy != nil {
		l = m.InternalActiveRedirectPolicy.SizeVT()
		n += 2 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
	return n
...
func (m *InternalActiveRedirectPolicy_RedirectPolicy) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if vtmsg, ok := m.RedirectUrlRewriteSpecifier.(interface{ SizeVT() int }); ok {
		n += vtmsg.SizeVT()
	}
	if len(m.Predicates) > 0 {
		for _, e := range m.Predicates {
...
func (m *InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrl) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InternalActiveRedirectPolicy_RedirectPolicy_RedirectUrlRewriteRegex) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.RedirectUrlRewriteRegex != nil {
		if size, ok := interface{}(m.RedirectUrlRewriteRegex).(interface {
			SizeVT() int
		}); ok {
			l = size.SizeVT()
		} else {
			l = proto.Size(m.RedirectUrlRewriteRegex)
		}
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	} else {
		n += 2
...
func (m *InternalActiveRedirectPolicy) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InternalActiveRedirectPolicy_RedirectUrl) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *InternalActiveRedirectPolicy_RedirectUrlRewriteRegex) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
